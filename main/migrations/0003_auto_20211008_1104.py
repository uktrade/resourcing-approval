    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_attributes_and_skills', models.TextField(help_text='Insert information about what the ideal candidate would be like in their character and what they’d bring to your team. This will enhance our search ability and interview quality.')),
                ...
                ('approval', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='statement_of_work', to='main.contractorapproval')),
            ],
        ),
    ]
